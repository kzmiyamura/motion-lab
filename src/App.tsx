    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <div className={styles.mainTabs}>
          <button
            className={`${styles.mainTabBtn} ${mainTab === 'youtube' ? styles.mainTabBtnActive : ''}`}
      ...
      {/* ── YouTube タブ（常時マウント：display:none で同時再生維持） ── */}
      <div className={mainTab === 'youtube' ? styles.tabPanel : styles.tabPanelHidden}>
      ...
      {/* ── Rhythm タブ（常時マウント：display:none でメトロノーム継続） ── */}
      <div className={mainTab === 'rhythm' ? styles.tabPanel : styles.tabPanelHidden}>
